<form id="commentform" class="contactform" method="post" action="">
	...
	<p class="content_name">
		...
		<label for="contact_name">
			<small><?php _e( 'Name', 'contact' ); ?> (<?php _e( 'required', 'contact' ); ?>)</small>
		</label>
	</p>
	<p class="content_email">
		...
		<label for="contact_email">
			<small><?php _e( 'Email', 'contact' ); ?> (<?php _e( 'required', 'contact' ); ?>)</small>
		</label>
	</p>
	<p class="content_phone">
		...
		<label for="contact_phone">
			<small><?php _e( 'Phone', 'contact' ); ?></small>
		</label>
	</p>
	...
	<p class="content_submit">
		<input type="submit" value="<?php _e( 'Send Message', 'contact' ); ?>" tabindex="5" id="submit" name="contact[submit]" />
	</p>
</form>