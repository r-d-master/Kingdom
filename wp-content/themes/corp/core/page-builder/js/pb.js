...
$(document).on('click', '.choose-sidebar', function () {
...
$(document).ready(function () {
    ...
    $(document).on('click', '.slider_type .available_media_item', function () {
        ...
        var available_media_item_this_thumburl = $(this).find('.previmg').attr('data-timthumb-url');
    ...
    $(document).on('click', '.bg_or_slider_option.bg_type .available_media_item', function () {
        ...
        var for_bg_data_preview_bg_image = $(this).find('.previmg').attr('data-timthumb-url');
    ...
    $(document).on("click", ".qshortcode_icon", function(){
    ...
    $(document).on("click", ".qsc_insert", function(){
        $(".quick_shortcodes_option").hide("fast");
    });

        /* CUSTOM BUTTON */
        $(document).on("click", ".custom_button_inserter", function(){
            ...
            $(this).parents(".edit_popup").find(".sc_inserted_here .enter_text1").val(tmp_txt_val + " " + "[custom_button style='"+custom_button_sc_type+"' target='"+custom_button_target+"' href='"+custom_button_sc_address+"']"+custom_button_sc_text+"[/custom_button]");
        });

        /* BLOCKQUOTE */
        $(document).on("click", ".blockquote_inserter", function(){
        ...
        /* Dropcaps */
        $(document).on("click", ".dropcaps_inserter", function(){
        ...
        /* Frame */
        $(document).on("click", ".frame_inserter", function(){
        ...
        /* Video */
        $(document).on("click", ".video_inserter", function(){
        ...
        /* Highlighter */
        $(document).on("click", ".highlighter_inserter", function(){
        ...
        /* Dividers */
        $(document).on("click", ".dividers_inserter", function(){
        ...
        /* Social */
        $(document).on("click", ".social_inserter", function(){
