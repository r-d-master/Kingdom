...
function toggles_item($atts, $content = null) {
	...
	extract( shortcode_atts( array(
		...
		$compile .= "<h5 data-count='".$toggtemmpi."' class='shortcode_toggles_item_title expanded_" . $expanded_state . "'>".$title."<span class='ico'></span></h5><div class='shortcode_toggles_item_body'><div class='ip'>".do_shortcode($content)."</div></div>";
