        ...
        <div class="team_slider">
            <div class="carouselslider teamslider items'.$posts_per_line.'" data-count="'.$posts_per_line.'">
					...
					<li>
                        <div class="item">
							...
							if (has_post_thumbnail()) {
								$compile .= '<img src="'.aq_resize($featured_image[0], "270", "170", true).'" alt="'.get_the_title().'" />';
							} else {
								$compile .= '<img src="'.aq_resize(IMGURL.'/core/team-unknown.jpg', "270", "170", true).'" alt="'.get_the_title().'" />';
							}
			   ...
			   $compile .= '
                        ...
                        if (strlen($facebook_link)>0) {$compile .= '<a target="_blank" href="'.$facebook_link.'" class="facebook_link tiptip" title="Facebook"></a>';}
                        if (strlen($flickr_link)>0) {$compile .= '<a target="_blank" href="'.$flickr_link.'" class="flickr_link tiptip" title="Flickr"></a>';}
                        if (strlen($twitter_link)>0) {$compile .= '<a target="_blank" href="'.$twitter_link.'" class="twitter_link tiptip" title="Twitter"></a>';}
                        if (strlen($LinkedIn_link)>0) {$compile .= '<a target="_blank" href="'.$LinkedIn_link.'" class="LinkedIn_link tiptip" title="LinkedIn"></a>';}
                        if (strlen($DeviantArt)>0) {$compile .= '<a target="_blank" href="'.$DeviantArt.'" class="DeviantArt tiptip" title="DeviantArt"></a>';}
                        if (strlen($vimeo_link)>0) {$compile .= '<a target="_blank" href="'.$vimeo_link.'" class="vimeo_link tiptip" title="Vimeo"></a>';}
                        if (strlen($tumblr_link)>0) {$compile .= '<a target="_blank" href="'.$tumblr_link.'" class="tumbler_link tiptip" title="Tumblr"></a>';}
                        if (strlen($linkedin_link)>0) {$compile .= '<a target="_blank" href="'.$linkedin_link.'" class="linkedin_link tiptip" title="LinkedIn"></a>';}
                        if (strlen($member_email)>0) {$compile .= '<a target="_blank" href="mailto:'.$member_email.'" class="member_email tiptip" title="Email"></a>';}
