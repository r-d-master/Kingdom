...
if (!function_exists('css_js_register')) {
	...
	{
        #CSS
    	wp_enqueue_style('css_default_style', get_bloginfo('stylesheet_url'));
        wp_enqueue_style('css_core_css', get_template_directory_uri() . '/css/core/core.css');
		...
		wp_enqueue_style('css_theme', get_template_directory_uri() . '/css/theme.css');
		wp_enqueue_style('css_core_php', get_template_directory_uri() . '/css/core/core.php');
		if (get_theme_option("site_width")=="960px") {wp_enqueue_style('css_960', get_template_directory_uri() . '/css/960.css');}

		#JS
		wp_enqueue_script("jquery");
        wp_enqueue_script(array("jquery-ui-core"));
        wp_enqueue_script('js_run', get_template_directory_uri() . '/js/run.js');
        wp_enqueue_script('js_theme', get_template_directory_uri() . '/js/theme.js', array(), false, true);
		wp_enqueue_script('js_core', get_template_directory_uri() . '/js/core/core.php', array(), false, true);
	}
}
