jQuery(function ($) {
    ...
    /* SIDEBAR MANAGER */
    $(document).on('click', '.create_new_sidebar_btn', function () {
    ...
    $(document).on('click', '.delete_this_sidebar', function () {
    ...
    $(document).on("click", ".addnewslide", function(){
        var data = {
    ...
    $(document).on("click", ".audioUpload", function () {
    ...
    $(window).load(function () {
        $(document).on("click", ".addnewslideforport", function () {
        ...
        $(document).on("click", ".delthisslideforport", function () {
