		...
		$compilepopular .= '
			<li '.((has_post_thumbnail()) ? '' : 'class="no_img"').'>';
                if (has_post_thumbnail()) {
                    $compilepopular .= '<div class="recent_posts_img"><img class="alignleft" src="'.aq_resize($featured_image_latest[0], "86", "86", true).'" alt="'.get_the_title().'"></div>';
                }

$compilepopular .= '
                <div class="recent_posts_content">
                    <span class="post_title"><a class="read_more" href="'.get_permalink().'">'.get_the_title().'</a></span>
                    '.smarty_modifier_truncate(get_the_excerpt(), ((has_post_thumbnail()) ? 85 : 105)).'
