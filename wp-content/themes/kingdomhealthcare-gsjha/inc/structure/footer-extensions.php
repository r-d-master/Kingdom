...
function interface_footer_info() {         
   ...
   $output = '<div class="copyright">'.__( 'Copyright &copy;', 'interface' ).' '.'[the-year] [site-link]'.' '.'<br/><a href="agency-terms-conditions">Agency Terms & Conditions</a><br/>Website by <a href="http://www.webvizion.co.uk" target="_blank">www.webvizion.co.uk</a></div><!-- .copyright -->';
